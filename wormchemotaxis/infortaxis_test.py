...
# -*- coding: utf-8 -*-
"""
Created on Fri Jun 21 17:15:30 2019
...
"""
infotaxis.py
(modify from https://github.com/rkp8000/infotaxis/blob/master/infotaxis.py)
...
def build_log_src_prior(prior_type, xs, ys):
    ...
    if prior_type == 'uniform':  #uniform prior distribution of source
...
fig, axs = plt.figure(figsize=(7,8), tight_layout=True), []
